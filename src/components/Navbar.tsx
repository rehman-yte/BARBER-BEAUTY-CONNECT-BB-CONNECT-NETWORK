      ...
      <div className="w-full max-w-[1440px] mx-auto px-3 sm:px-6 md:px-[5%] h-full flex justify-between items-center gap-2">
        ...
        <div className="flex items-center gap-1.5 xs:gap-2.5 sm:gap-4 md:gap-6 shrink-0">
          ...
          {isLoggedIn && user.role === 'admin' && (
            <Link to="/admin/dashboard" className={`text-[0.55rem] sm:text-[0.625rem] font-bold uppercase tracking-[0.05em] sm:tracking-[0.2em] whitespace-nowrap ${location.pathname === '/admin/dashboard' ? 'text-bbBlue' : 'text-black hover:text-bbBlue'}`}>
              Admin
            </Link>
          )}
