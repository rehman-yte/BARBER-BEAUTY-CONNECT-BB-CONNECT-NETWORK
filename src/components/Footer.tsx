...
const Footer: React.FC = () => {
  return (
    <footer className="bg-charcoal text-blue-50 pt-[5rem] pb-[2.5rem]">
      <div className="max-w-[1440px] mx-auto px-[5%]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[4rem] text-center md:text-left">
        ...
        {/* Socials Column */}
        <div className="flex flex-col gap-[1.5rem]">
          <h4 className="text-[0.625rem] font-bold text-white uppercase tracking-[0.3em] border-b border-bbBlue/20 pb-[0.5rem] inline-block md:self-start">Follow Excellence</h4>
          <div className="flex justify-center md:justify-start gap-[2rem] items-center">
             {/* Instagram - Clickable */}
             <a 
             ...
             >
               <svg className="w-[1.5rem] h-[1.5rem]" fill="currentColor" viewBox="0 0 24 24">
             ...
             <span className="text-blue-300/30 cursor-default pointer-events-none" aria-label="Twitter">
               <svg className="w-[1.5rem] h-[1.5rem]" fill="currentColor" viewBox="0 0 24 24">
             ...
             <span className="text-blue-300/30 cursor-default pointer-events-none" aria-label="LinkedIn">
               <svg className="w-[1.5rem] h-[1.5rem]" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Contact Column */}
        <div className="flex flex-col gap-[1.5rem]">
          <h4 className="text-[0.625rem] font-bold text-white uppercase tracking-[0.3em] border-b border-bbBlue/20 pb-[0.5rem] inline-block md:self-start">Reach Out</h4>
          <div className="flex flex-col gap-[0.75rem] text-[0.75rem] font-medium text-blue-100/90">
            ...
            <span className="text-blue-200/70">Uttar Pradesh, India</span>
          </div>
        </div>
      </div>
