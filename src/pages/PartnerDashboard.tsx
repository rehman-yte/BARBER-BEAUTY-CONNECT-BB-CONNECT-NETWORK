  ...
  return (
    <div className="flex min-h-screen bg-gray-50/30">
      ...
      <aside className="w-[18rem] bg-charcoal text-white flex-shrink-0 hidden xl:flex flex-col border-r border-white/5 pt-[1rem]">
        ...
        <div className="mt-auto p-[2rem] border-t border-white/5 opacity-50">
          <p className="text-[0.5625rem] font-bold text-gray-500 uppercase tracking-[0.3em]">Network Station Active</p>
        </div>
      </aside>
