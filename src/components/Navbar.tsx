        ...
        <div className="flex items-center gap-[1rem] sm:gap-[2rem]">
          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-4">
              <Link to="/shop" className="relative p-2 text-gray-400 hover:text-bbBlue"><ShoppingBag size={20} />{totalItems > 0 && <span className="absolute top-1 right-1 min-w-[1rem] h-4 bg-bbBlue text-white text-[10px] flex items-center justify-center rounded-full border-2 border-white px-1">{totalItems}</span>}</Link>
