        ...
        <div className="fixed inset-0 z-[3000] flex items-center justify-center p-4">
          ...
          >
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-[0.75rem] py-[1.25rem] bg-white border border-gray-100 rounded-3xl hover:bg-gray-50 transition-all mb-[1.5rem] group disabled:opacity-50 active:scale-95 shadow-sm"
            >
            ...
            {error && <p className="text-[0.625rem] text-red-500 font-bold uppercase tracking-widest text-center mt-4">{error}</p>}
